  ...
  function renderCard() {
    ...
    if (!state.item) {
      card.appendChild(el('div', {
        style: { color: '#606080', padding: '2rem', textAlign: 'center' },
      }, 'Loading pricing…'));
      return;
    }
    ...
    card.appendChild(el('div', {
      ...
      style: { background: '#111120', borderColor: 'rgba(180,255,69,0.35)' },
    },
      el('span', {
      ...
      el('button', {
        ...
        style: {
          background: disabled ? '#252545' : 'linear-gradient(135deg, #b4ff45, #7fc718)',
          color: disabled ? '#808098' : '#000',
          fontWeight: 700,
          fontSize: '0.9rem',
        ...
        icon('creditCard', { size: 16, color: disabled ? '#808098' : '#000' }),
