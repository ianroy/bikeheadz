...
const FAQ = [
  ...
  { q: 'How does my head attach to the valve stem?', a: 'The head/neck piece has a threaded socket that screws over the top of a Presta valve. It replaces the standard dust cap and twists on in seconds.' },
...
function prestaPara() {
  return [
    'A ',
    el('strong.text-white', {}, 'Presta valve stem'),
    " is the narrow, threaded valve found on most road and gravel bikes. It's typically 60–80mm long and 6mm in diameter.",
  ];
}
...
function capPara() {
  return [
    ...
    el('strong.text-white', {}, 'custom 3D-scanned head'),
    '. The neck piece has an internal thread that matches the standard Presta valve thread — so it just screws on.',
  ];
}
